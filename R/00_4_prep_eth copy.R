...
if(!dir.exists(path_biofuels)) dir.create(path_biofuels, recursive = TRUE)
...
biofuels_eia_cols <- c("character", "character", rep("character", length(1980:2022)))
...
if(!biofuels_eia[[2]][1] == "Afghanistan" &&
  !biofuels_eia[[2]][nrow(biofuels_eia)] == "Zimbabwe") {
